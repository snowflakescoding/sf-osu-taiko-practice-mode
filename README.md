...
### **v1.6: Pause System Enhancements**
...
### **v1.1: Core Features & Persistence**
...
1. **Clone the repository**:
   ```
   git clone [https://github.com/YOUR_USERNAME/sf-osu-taiko-practice-mode-app.git](https://github.com/YOUR_USERNAME/sf-osu-taiko-practice-mode-app.git)
   ```

2. **Open the folder**:
    ```
    cd sf-osu-taiko-practice-mode-app
    ```
